...
$(document).ready(function () {
 ...
 <div class="center-menu">
            <label class="menu-button" for="menu-open" aria-hidden="true"><span class="fa fa-bars fa-2x"></span></label>
            <input class="menu-open" id="menu-open" type="checkbox" aria-hidden="true" />
            <nav class="menu" role="navigation">
              <a href="#" class="nav-1">github</a>
              <a href="#" class="nav-2">about me</a>
              <a href="#" class="nav-3">resume</a>
            </nav>
          </div>
